...
<script type="text/javascript">
    ...
    var uname = document.UserRegistration.firstname;
    var uemail = document.UserRegistration.email;
    var uaddress=document.UserRegistration.address;
    var utel=document.UserRegistration.tel;
    var uage=document.UserRegistration.age;
    // Convert user entered age to a number
    var ugender=document.UserRegistration.gender;
    var upassword= document.UserRegistration.password;
    var uconfirmpassword = document.UserRegistration.confirmpassword;
...
<form name='UserRegistration' method="post" action="InsertData.php" onSubmit="return formValidation()">
...
<img src="logo.png" class="logo">
  <div class="Title">CREATE ACCOUNT</div>
        ...
        <div class="textbox">
          <label>ID</label>
          <input type="text" class="input" name="did" id="did">
       </div>  
