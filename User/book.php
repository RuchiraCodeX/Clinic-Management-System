...
<body style="background-image:url()">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="Login Form.php" class="logo"></li>
	...
	<div class="sucontainer">
		...
		<label style="font-size:20px" >District</label><br>
...
if(isset($_POST['submit']))
{
		...
		if(!empty($_POST['fname'])&&!empty($_POST['gender'])&&!empty($_SESSION['username'])&&!empty($_POST['Clinic'])&&!empty($_POST['Doctor']) && !empty($_POST['dov']))
		{
			...
			else
			{
				...
				{
					echo '<script>alert("Booking successful! Redirecting to home page....")</script>';
